...
export function createStatusBar(scene) {
    ...
    scene.titleLVL = scene.add.text(853, 22, 0, { fontFamily: 'Arial', fontSize: 18, color: '#ffffff', stroke: "#000000", strokeThickness: 3 }).setDepth(2);
    scene.titleWAVE = scene.add.text(853, 56, 0, { fontFamily: 'Arial', fontSize: 18, color: '#ffffff', stroke: "#000000", strokeThickness: 3 }).setDepth(2);
