...
export function createStatusBar(scene) {
    ...
    scene.titleHP = scene.add.text(240+210, 22, 0, { fontFamily: 'ClearSans', fontSize: 18, color: '#ffffff', stroke: "#000000", strokeThickness: 3 }).setDepth(2);
    scene.titleMP = scene.add.text(240+210, 56, 0, { fontFamily: 'ClearSans', fontSize: 18, color: '#ffffff', stroke: "#000000", strokeThickness: 3 }).setDepth(2);
    scene.titleLVL = scene.add.text(853+210, 22, 0, { fontFamily: 'Arial', fontSize: 18, color: '#ffffff', stroke: "#000000", strokeThickness: 3 }).setDepth(2);
    scene.titleWAVE = scene.add.text(853+210, 56, 0, { fontFamily: 'Arial', fontSize: 18, color: '#ffffff', stroke: "#000000", strokeThickness: 3 }).setDepth(2);
    scene.titleCOIN = scene.add.text(1130+210, 22, 0, { fontFamily: 'ClearSans', fontSize: 18, color: '#ffffff', stroke: "#000000", strokeThickness: 3 }).setDepth(2);
...
export function setStatusLVL(scene, currXP, maxXP, LVL, skillPoints) {
    ...
    var rect = new Phaser.Geom.Rectangle(840+210, 26, 217 * currXP / maxXP, 14);
...
export function setStatusWAVE(scene, type, coef, numWave = 0, numHPBoss = 0) {
    ...
    if (type == 1) {
        if (numHPBoss > 0) {
            ...
            scene.titleWAVE.setText(`${numWave}               BOSS: 0 HP`);
        }
